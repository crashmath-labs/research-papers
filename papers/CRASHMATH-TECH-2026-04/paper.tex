...
\author{
    \textbf{Dr. Daniel Reeves, Ph.D.}$^1$ \quad \textbf{Elena Varga, M.Sc.}$^2$ \\
    \small CrashMath Quantitative Research Labs, London, UK \\
    \small $^1$\texttt{daniel.reeves@crashmath.org} \quad $^2$\texttt{elena.varga@crashmath.org} \\
